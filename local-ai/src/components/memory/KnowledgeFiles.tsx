    ...
    return (
      <div className="rounded-3xl border border-dashed border-border bg-background/60 p-6 text-center">
        ...
        <p className="mt-2 text-xs leading-6 text-muted-foreground">
          ...
          folder to give your workspace local reference material.
        </p>
        <p className="mt-2 text-xs leading-6 text-muted-foreground">
  ...
  return (
    <div className="space-y-3">
      <p className="text-xs leading-6 text-muted-foreground">
        These files are loaded into your workspace context. Files added outside the app appear here after refresh.
      </p>
